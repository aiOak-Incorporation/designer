"""
Django settings for redym project.
"""
...
SPECTACULAR_SETTINGS = {
    "TITLE": "Redym Fashion Portfolio API",
    "DESCRIPTION": "REST API for Manya’s fashion portfolio (brand redym).",
    "VERSION": "1.0.0",
}
...
ROOT_URLCONF = "redym.urls"

# --- Static & Media ---
STATIC_URL = "/static/"
STATICFILES_DIRS = [BASE_DIR / "redym_portfolio" / "static"]
...
TEMPLATES = [
    {
        ...
        "DIRS": [BASE_DIR / "redym_portfolio" / "templates"],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
WSGI_APPLICATION = "redym.wsgi.application"
...
DEFAULT_FROM_EMAIL = "no-reply@redym.com"
